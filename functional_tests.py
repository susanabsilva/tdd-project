...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # e mostra a lista "1: Estudar testes funcionais"
        ...
        # Ainda existe uma caixa de texto convidando
        # para adicionar outro item
        ...
        # A página atualiza novamente,
        # e agora mostra ambos os itens na sua lista
        table = self.browser.find_element(By.ID, 'id_list_table')
        rows = table.find_elements(By.TAG_NAME, 'tr')
        ...
        # Então, ela verifica que o site gerou uma URL única para ela.
        #
